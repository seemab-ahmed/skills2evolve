...
const Future = () => {
  return (
     <div>
        <div className=" m-auto mx-5 bg-[#242F3B] flex md:flex-row flex-col lg:gap-[52px] gap-[30px] lg:pr-[37px] pr-[20px] lg:pl-[57px] pl-[20px] pt-[44px] pb-[56px] rounded-2xl">
         ...
         <div className="md:max-w-[609px] w-full">

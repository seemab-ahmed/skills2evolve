...
export default function BlogdetailComponent({ blog, relatedPosts }) {
  return (
    <div className="">
      ...
      <div className="bg-gray-50 px-5 md:pt-[120px] pt-[80px] pb-[66px]">
        ...
        <div className="flex flex-col gap-6 border-b border-[#D1D1D1] pb-[40px]">
            {blog.content.map((block, index) => {
                ...
                return (
                    <h2 key={index} className='text-[#1E1E1E] text-[18px] font-semibold'>
                    {block.text}
                    </h2>
                );
                }
                ...
                if (block.type === 'list') {
                return (
                    <ul key={index} className='list-decimal ml-5 text-[#1E1E1E] text-[16px] font-normal'>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
          {relatedPosts.map((post) => (
            <Link key={post.slug} href={`/blog/${post.slug}`}>
              <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all ease-in-out duration-500">
                <div className='flex'>
                  <Image
                    src={post.image}
                    width={400}
                ...
                <div className='p-[15px]'>
                  <h4 className='line-clamp-1 text-[#1E1E1E] text-[18px] font-semibold mb-3'>{post.title}</h4>
                  ...
                  <div className="flex items-center justify-between w-full">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[#707070]">{post.date}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-1 text-gray-500 text-sm">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.83883 14.5185C7.68167 14.5185 7.53094 14.456 7.41981 14.3449C7.30867 14.2338 7.24624 14.0831 7.24624 13.9259V12.1481H4.87587C4.56154 12.1481 4.26008 12.0232 4.03782 11.801C3.81555 11.5787 3.69068 11.2773 3.69068 10.9629V5.037C3.69068 4.72267 3.81555 4.42121 4.03782 4.19895C4.26008 3.97668 4.56154 3.85182 4.87587 3.85182H13.1722C13.4865 3.85182 13.788 3.97668 14.0102 4.19895C14.2325 4.42121 14.3573 4.72267 14.3573 5.037V10.9629C14.3573 11.2773 14.2325 11.5787 14.0102 11.801C13.788 12.0232 13.4865 12.1481 13.1722 12.1481H10.7425L8.54994 14.3466C8.43142 14.4592 8.28328 14.5185 8.13513 14.5185H7.83883ZM8.43142 10.9629V12.7881L10.2566 10.9629H13.1722V5.037H4.87587V10.9629H8.43142ZM2.5055 9.77774H1.32031V2.66663C1.32031 2.3523 1.44518 2.05084 1.66745 1.82858C1.88971 1.60631 2.19117 1.48145 2.5055 1.48145H11.987V2.66663H2.5055V9.77774Z" fill="#707070"/>
                        </svg>
